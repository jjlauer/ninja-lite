...
@Singleton
public class BodyParserEngineManagerImpl2 implements BodyParserEngineManager {

    private final Logger logger = LoggerFactory.getLogger(BodyParserEngineManagerImpl2.class);
    ...
    @Inject
    public BodyParserEngineManagerImpl2(Injector injector) {
